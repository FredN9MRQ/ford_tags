...
| 10.0.10.28 | esphome | ESPHome | bc:24:11:8f:eb:eb | 🔄 To Reserve | Currently at .113 |
...
- [ ] Update DHCP range to 10.0.10.50-254

### Phase 2: Update Existing Reservations 🔄
- [x] homelab-command: .92 → .10 ✅
- [ ] HP iLO: .53 → .13
- [ ] ad5m: .189 → .30

### Phase 3: Create New Reservations for VMs 🔄
- [ ] openmediavault: .178 → .5
- [x] homeassistant: .194 → .24 ✅
- [ ] dockge: .104 → .27
- [ ] esphome: .113 → .28
- [ ] docker: .108 → .29
- [ ] pve-scripts-local: .79 → .40
